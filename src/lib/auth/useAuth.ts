...
export const useAuth = () => {
  ...
  const login = async (params?: LoginParams) => {
    ...
    redirectUri = redirectUri || 'https://localhost:4200/signin-oidc'
  ...
  const logout = () => {
    ...
    endSessionUrl.searchParams.set('post_logout_redirect_uri', 'https://localhost:4200/signout-callback-oidc')
